                                ...
                                <NavigationMenuLink asChild>
                                    ...
                                    >
                                        ...
                                        <p className="text-sm text-muted-foreground">
                                            Tu solución definitiva para la gestión de redes sociales
                                        </p>
                                    </Link>
                                </NavigationMenuLink>
                            </li>
                            <Item title="Calendario de Contenido" href="/features/content-calendar" icon={<CalendarRangeIcon className="w-5 h-5" />}>
                                Planifica y visualiza tu estrategia de contenido.
                            </Item>
                            <Item title="Gestor de Hashtags" href="/features/hashtag-manager" icon={<HashIcon className="w-5 h-5" />}>
                                Investiga y sigue los hashtags en tendencia.
                            </Item>
                            <Item title="Análisis de la Competencia" href="/features/competitor-analysis" icon={<UsersIcon className="w-5 h-5" />}>
                                Supervisa y analiza el rendimiento de la competencia.
                            </Item>
                        </ul>
                    </NavigationMenuContent>
                </NavigationMenuItem>
                    ...
                    <NavigationMenuContent>
                        <ul className="grid w-[400px] gap-3 p-4 md:w-[400px] md:grid-cols-2 lg:w-[500px] xl:w-[500px]">
                            <Item title="Blog" href="/resources/blog" icon={<Newspaper className="w-5 h-5" />}>
                                Lee nuestros últimos artículos y actualizaciones.
                            </Item>
                            <Item title="Soporte" href="/resources/support" icon={<CircleHelp className="w-5 h-5" />}>
                                Obtén ayuda con cualquier problema que puedas tener.
                            </Item>
                        </ul>
                    </NavigationMenuContent>
                </NavigationMenuItem>
